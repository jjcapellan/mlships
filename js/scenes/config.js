class Configuration extends Phaser.Scene {
    ...
    create() {
        ...
        // Data labels
        this.lbl_population = this.add.bitmapText(centerX,135,'bmf',`${POPULATION_AMOUNT}`,20).setOrigin(0.5);
        this.lbl_detection = this.add.bitmapText(centerX,205,'bmf',`${DETECTION_RADIUS}`,20).setOrigin(0.5);
        this.lbl_hiddenNeurons = this.add.bitmapText(centerX,275,'bmf',`${START_HIDDEN_SIZE}`,20).setOrigin(0.5);
        // Buttons
